...
var (
	...
	CodeTypeEncodingError = errs(12001, "Expected 'pubkey/power'. Got %v")
	CodeTypeBadNonce = errs(12002, "ok")
	CodeTypeUnauthorized = errs(12003, "Cannot remove non-existent validator %X")
	CodeTypeBadOption = errs(12004, "ok")
